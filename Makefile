...
.PHONY: lint
lint:
	-docker run --rm -v .:/source -v $(GOLANGCI_LINT_CACHE):/root/.cache -w //source golangci/golangci-lint:v1.64.6 golangci-lint run -c .golangci.yml > ./.golangci-lint/report-unformatted.json
