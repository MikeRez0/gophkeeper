...
func (r *KeychainPgRepository) KeychainInsert(ctx context.Context, kcdata *domain.KCData) (*domain.KCData, error) {
...
func (r *KeychainPgRepository) KeychainUpdate(ctx context.Context, kcdata *domain.KCData) (*domain.KCData, error) {
	err := pgx.BeginFunc(ctx, r.db, func(tx pgx.Tx) error {
